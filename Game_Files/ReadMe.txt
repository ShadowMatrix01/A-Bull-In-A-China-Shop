...
<h1>Date: 06-26-2025, 5:30 PM EST  <br>
<h1>Version (Pre-Release): 1.0.4  <br>
...
<h1>DONE: Bull movement across the x axis, bull drawing, item spawning and respawning logic, points accumulated, player jumping, partially(game over screen), reset, windows scaling set to 100%, bgm (select), out_of_bounds <br>
